...
let rec trans_obj : Sm5.obj -> Sonata.obj = function
  ...
  | Sm5.Fn (arg, command) ->
    Sonata.Fn (arg,
      (trans' [Sm5.PUSH (Sm5.Id "#ret_func_addr"); Sm5.LOAD; Sm5.BIND "#ret_func"]) @
      (* whole command need to be translated because of CALL logic*)
(*       (trans' command) @
      (trans' [Sm5.PUSH (Sm5.Id "#ret_func"); Sm5.PUSH (Sm5.Val Sm5.Unit); Sm5.PUSH (Sm5.Id "#_"); Sm5.CALL]) *)
      (trans' (command @ [Sm5.PUSH (Sm5.Id "#ret_func"); Sm5.PUSH (Sm5.Val Sm5.Unit); Sm5.PUSH (Sm5.Id "#_"); Sm5.CALL]))
    )
...
and trans' : Sm5.command -> Sonata.command = function
  ...
  | Sm5.CALL :: cmds ->
     (* should use Sonata.PUSH instead of Sm5.PUSH because of trans_obj logic *)
    (* (trans' [Sm5.PUSH (Sm5.Fn ("#__", [Sm5.UNBIND; Sm5.POP] @ cmds)); Sm5.PUSH (Sm5.Id "#ret_func_addr"); Sm5.STORE]) @ *)
    [Sonata.PUSH (Sonata.Fn ("#__", trans' ([Sm5.UNBIND; Sm5.POP] @ cmds)))] @
    (trans' [Sm5.PUSH (Sm5.Id "#ret_func_addr"); Sm5.STORE]) @
    [Sonata.CALL]
...
let trans : Sm5.command -> Sonata.command = fun command ->
  (* malloc variables to be used *)
  (trans' [Sm5.MALLOC; Sm5.BIND "#_"; Sm5.MALLOC; Sm5.BIND "#__"; Sm5.MALLOC; Sm5.BIND "#ret_func_addr"; Sm5.MALLOC; Sm5.BIND "#ret_func"]) @
  (trans' command) @
  (trans' [Sm5.UNBIND; Sm5.POP; Sm5.UNBIND; Sm5.POP; Sm5.UNBIND; Sm5.POP; Sm5.UNBIND; Sm5.POP;])
